var instructions_1a_text = function(){
	var instructions = [
	"<div align=center>In this game, you will be taking a spaceship from earth<br> to look for space treasure on two different planets:<br><br><img style='margin:0px auto;display:block;height:200px' src='./tasks/two-arm-new/img/example_planets.png'/></div>",
	"<div align=center>Each planet has two aliens on it and each alien has its own space treasure mine.<br><br><img style='margin:0px auto;display:block;height:100px' src='./tasks/two-arm-new/img/example_aliens.png'/><br>Once you arrive to each planet, you will ask one of the aliens for space treasure from its mine.</div>",
	"<div align=justify>These aliens are nice, so if an alien just brought treasure up from the mine, it will share it with you. Space treasure looks like this:<br><br><img style='margin:0px auto;display:block' src='./tasks/two-arm-new/img/treasure.png'/><br>Sometimes, the alien will not bring up any treasure and you'll see an empty circle:<br><br><img style='background-color: gray;margin:0px auto;display:block' src='./tasks/two-arm-new/img/noreward.png'/></div>",
