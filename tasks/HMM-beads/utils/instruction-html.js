var beads_instructions_1_text = function() {
  var html_arr = [
    ...
    `<div align=center><img src="tasks/HMM-beads/Instructions/Slide1.png" width="800"><br><br>A black bead was drawn from the 80% black jar.<br><br></div>`,
    `<div align=center><img src="tasks/HMM-beads/Instructions/Slide2.png" width="800"><br><br>The jar being used switched.<br><br>Now, a white bead was drawn from the 80% white jar.<br><br></div>`,
    `<div align=center><img src="tasks/HMM-beads/Instructions/Slide3.png" width="800"><br><br>The jar being used switched again.<br><br>However, a low-probability white bead was drawn from the 80% black jar.<br><br></div>`,
