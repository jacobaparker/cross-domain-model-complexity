...
beads_json4 = './tasks/HMM-beads/stimuli/low_hazard_H01_N375.json'
beads_json5 = './tasks/HMM-beads/stimuli/high_hazard_H99_N375.json'
...
csv_to_json(beads_csv4,beads_json4)
csv_to_json(beads_csv5,beads_json5)
